...
export const GradientCard = ({ title, description, icon, learnMoreText = "Learn More", onClick, className = "" }) => {
  ...
  return (
    <motion.div
      ref={cardRef}
      className={`relative rounded-[32px] overflow-hidden cursor-pointer ${className}`}
      style={{
        width: "360px",
        height: "450px",
